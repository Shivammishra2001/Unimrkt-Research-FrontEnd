...
/** /work-with-us hero + breadcrumb — Figma node 924:23216 (y0-828). Same
 * dark full-bleed shell as every other detail-page hero this session,
 * with a 2-level breadcrumb (Home > Work With Us) matching this node's
 * own breadcrumb text exactly. */
export function HeroSection({ hero }: { hero: ResolvedWorkWithUs['hero'] }) {
  return (
    <>
      ...
      <div className="w-full bg-white shadow-[0px_2px_8px_0px_rgba(0,0,0,0.04)]">
        <div className="mx-auto flex w-full max-w-container items-center gap-2 px-4 py-4 sm:px-6 lg:px-8">
          ...
          <span className="min-w-0 flex-1 truncate font-sans text-sm text-[#868484]">Work With Us</span>
        </div>
      </div>
    </>
  );
