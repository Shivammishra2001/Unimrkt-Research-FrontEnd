 ...
 * Medium, 90% opacity) centered below it, and a "View Profile" button
 * at the bottom. The button opens TeamProfileModal (Figma node
 * 1126:55196) — see OurTeamView.tsx for the open/close state. Each
 * card's photo-panel tint is a barely-visible near-white shade unique
 * per instance on the node (#f6f5f5/#f9f7f3/#f4f4f4/etc.) — simplified
 * here to one consistent neutral panel color, the same "decorative
 * crop-mask" simplification convention used for every other page's
 * card-photo masking this session. */
